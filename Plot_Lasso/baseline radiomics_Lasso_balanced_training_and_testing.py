...
# model = ElasticNetCV(alphas=arange(0, 1, 0.01), cv=cv, n_jobs=-1)
# shows the best convergence
alphas = np.logspace(-4, -0.5, 30)
model = LassoCV(alphas=alphas,  fit_intercept=False, tol=1e-6,
...
import xlsxwriter
workbook = xlsxwriter.Workbook('baseline radiomics_Lasso_balanced.xlsx')
...
# show the plot
# plt.show()
plt.savefig('baseline radiomics_Lasso_balanced.png')
