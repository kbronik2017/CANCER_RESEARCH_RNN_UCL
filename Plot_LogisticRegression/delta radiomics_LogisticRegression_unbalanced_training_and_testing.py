...
def predict_print(model):
    ...
    for i in range(len(Testx)):
        ...
        print("Predicted result: is: %.3f, Target result is: %.3f" %(result[0][1], Testy[i]))
...
import xlsxwriter
workbook = xlsxwriter.Workbook('delta radiomics_LogisticRegression_unbalanced.xlsx')
...
# show the plot
# plt.show()
plt.savefig('delta radiomics_LogisticRegression_unbalanced.png')
