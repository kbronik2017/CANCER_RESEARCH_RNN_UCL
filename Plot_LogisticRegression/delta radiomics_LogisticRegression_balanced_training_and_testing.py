...
Trainx = delta_radiomics[:38, :]
Trainy = y[:38]
Testx = delta_radiomics[38:, :]
Testy = y[38:]
...
import xlsxwriter
workbook = xlsxwriter.Workbook('delta radiomics_LogisticRegression_balanced.xlsx')
...
# show the plot
# plt.show()
plt.savefig('delta radiomics_LogisticRegression_balanced.png')
