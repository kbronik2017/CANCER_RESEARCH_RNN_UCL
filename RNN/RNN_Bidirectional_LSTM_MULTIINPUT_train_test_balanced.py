...
# balanced_training_and_testing
x_train_1 = TRAIN1[:30,]
x_train_2 = TRAIN2[:30,]
x_test_1 = TRAIN1[30:38,]
x_test_2 = TRAIN2[30:38,]
sample_1 = TRAIN1[38:,]
sample_2 = TRAIN2[38:,]
y_train = Ytrain[:30]
y_test = Ytrain[30:38]
sample_label = Ytrain[38:]
...
model_weights = THIS_PATH + '/MODEL/' + 'model_weights_Bidirectional_LSTM_balanced.hdf5'
